...
const MobileNav = ({state, dispatch}) => {
  ...
  return (
    <nav className={`${styles.transition} ${state.menu?'translate-y-0 opacity-100':'-translate-y-[2000px] opacity-0'} z-19 transform fixed ${!pageScrollDown? 'top-[85px]':'top-[70px]'} left-0 bg-primary w-[100%] h-[100%] pt-[60px] before:content-[''] before:absolute before:inset-0 before:bg-[rgba(219,207,247,0.05)] before:backdrop-blur-[.5px]`}>
